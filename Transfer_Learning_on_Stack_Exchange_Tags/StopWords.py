...
stop_words = stop_words = set(['a', "a's", 'able', 'about', 'above', 'according',
 ...
 'apart', 'appear', 'appreciate', 'appropriate', 'are', "aren't", 'around', 'as',
 'aside', 'ask', 'asking', 'associated', 'at', 'available', 'away', 'awfully',
 'b', 'be', 'became', 'because', 'become', 'becomes', 'becoming', 'been', 'before',
 ...
 'did', "didn't", 'different', 'do', 'does', "doesn't", 'doing', "don't", 'done',
 ...
 'greetings', 'h', 'had', "hadn't", 'happens', 'hardly', 'has', "hasn't", 'have',
 ...
 'useful', 'uses', 'using', 'usually', 'uucp', 'v', 'value', 'various', 'very', 'via', 'viz',
 'vs', 'w', 'want', 'wants', 'was', "wasn't", 'way', 'we', "we'd", "we'll", "we're", "we've",
